...
/**
 * PHP class for sending  SMS via ByteHand
 * http://bytehand.com
 */
class byteHandApi
{
    ...
    function __construct($id, $key, $from)
    {
        ...
        $this->key = $key;
        $this->from = $from;
        $this->url = 'http://bytehand.com:3800/send';
    }
    ...
    /**
     * Convert phone number in Russian format
     * @param $phone - number
     * @return mixed - formatted number
     */
    function format($phone)
    {
        $number = preg_replace("|[^0-9]|i", "", $phone);
        return preg_replace("|^8|", 7, $number);
    }
}